...
If you have an Xbox Kinect model 1473 or Kinect4Windows device, it will not currently work using ofxKinect on OSX. The [fix is in the works](https://github.com/OpenKinect/libfreenect/pull/325).
